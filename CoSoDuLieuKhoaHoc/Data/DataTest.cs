...
namespace CoSoDuLieuKhoaHoc.Data
{
    public class DataTest
    {
        public List<test> datatesst = new List<test>()
      {
        ...
        new test() { str1 = " Cao đẳng",str2 = "TÂM LÝ HỌC",str3 = "KỸ THUẬT THỰC PHẨM VÀ ĐỒ UỐNG",str4 = "Nguyễn Văn D",date1=DateTime.Today, date2=DateTime.Now,so1 = 575,so2 = 345345,so3 = 4562,so4 = 7696,so5=23570 },
        new test() { str1 = "Đại học ",str2 = "XÃ HỘI HỌC",str3 = "NCÔNG NGHỆ SINH HỌC MÔI TRƯỜNG",str4 = "Nguyễn Văn D",date1=DateTime.Today, date2=DateTime.Now,so1 = 987,so2 = 6457578,so3 = 2346,so4 = 2354,so5=809867 },
        };
    }
}
